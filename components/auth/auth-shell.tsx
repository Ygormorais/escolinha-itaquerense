...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,_#fbf8f6_0%,_#f6f0ee_100%)] text-foreground">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <div className={cn("grid w-full overflow-hidden rounded-[28px] border border-white/70 bg-white/88 shadow-[0_24px_80px_rgba(74,11,11,0.14)] backdrop-blur supports-[backdrop-filter]:bg-white/82 lg:grid-cols-[1.05fr_0.95fr]", styles.panel)}>
          <section className="flex flex-col justify-between gap-10 border-b border-black/5 px-6 py-8 sm:px-8 sm:py-10 lg:border-b-0 lg:border-r lg:px-10 lg:py-12">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-medium text-brand-900">Escolinha Itaquerense</p>
                </div>
              </div>

              <div className="max-w-xl space-y-4">
                <h1 className="text-4xl font-extrabold tracking-tight text-[var(--color-ink-950)] sm:text-5xl sm:leading-[1.05]">
                  {title}
                </h1>
                <p className="max-w-lg text-[15px] leading-7 text-[var(--color-ink-700)] sm:text-base">
                  {description}
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
              <div className="rounded-[22px] border border-black/6 bg-white/78 p-5 shadow-[0_12px_30px_rgba(74,11,11,0.08)]">
                ...
                <p className="mt-2 text-lg font-semibold text-[var(--color-ink-950)]">
                  {accentValue}
                </p>
              </div>
