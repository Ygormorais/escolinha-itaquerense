...
const css = `
  ...
  .lp .jc{background:var(--red-deep);color:#fff;padding:26px 0}
  .lp .jc .section-title{color:#fff;border-left-color:#fff;margin-bottom:16px}
  .lp .jc-tabs{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:18px}
  .lp .jc-tab{font-family:var(--font-heading),sans-serif;text-transform:uppercase;letter-spacing:.5px;font-weight:700;font-size:13px;padding:8px 16px;border-radius:4px;border:2px solid rgba(255,255,255,.25);background:transparent;color:#fff;cursor:pointer;transition:.2s}
  .lp .jc-tab.active{background:#fff;color:var(--red)}
  .lp .jc-track{display:flex;gap:16px;overflow-x:auto;scroll-snap-type:x mandatory;padding-bottom:6px}
  .lp .jc-card{scroll-snap-align:start;flex:0 0 280px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.14);border-radius:10px;padding:16px;transition:.2s}
  .lp .jc-card.focus{background:rgba(255,255,255,.16);border-color:rgba(255,255,255,.4)}
  .lp .jc-comp{font-family:var(--font-heading),sans-serif;text-transform:uppercase;font-size:12px;letter-spacing:.5px;opacity:.8;margin-bottom:10px}
  ...
  .lp .jc-score{font-family:var(--font-heading),sans-serif;font-size:26px;font-weight:700}
