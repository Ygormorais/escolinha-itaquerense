...
const actions = [
  ...
  { href: "/caixa", label: "Ver Caixa", icon: TrendingUp, color: "text-muted-foreground bg-muted" },
]
      ...
      {actions.map((a) => {
        ...
        return (
          <Link
            key={a.href}
            href={a.href}
            className="flex flex-col items-center gap-1.5 rounded-xl border bg-card p-3 text-center text-xs transition-colors hover:bg-muted"
          >
