...
const MODALIDADES = {
  ...
  federado: {
    ...
    icon: "ti-trophy",
    desc: "Times competitivos em campeonatos federados",
...
const css = `
  ...
  .hc .tab-btn.active-escolinha{background:linear-gradient(135deg,var(--red),#E53935);color:#fff}
  .hc .tab-btn.active-escolinha i{color:rgba(255,255,255,.9)}
  .hc .tab-btn.active-escolinha .tab-label span{opacity:.85}
  .hc .tab-btn.active-federado{background:linear-gradient(135deg,#1A1A2E,#2D2D4E);color:#fff}
  ...
  .hc .sub-chip.active-fed{background:#1A1A2E;border-color:#1A1A2E;color:#fff;
    box-shadow:0 3px 10px rgba(26,26,46,.25)}
  .hc .sub-chip.active-fed:hover{background:#2D2D4E}
  ...
  .hc .tcard-accent-red{height:5px;background:linear-gradient(90deg,var(--red),#E53935)}
  .hc .tcard-accent-dark{height:5px;background:linear-gradient(90deg,#1A1A2E,#3D3D6E)}
  ...
  .hc .tcard-age-dark{color:#3D3D6E;background:rgba(26,26,46,.08)}
  ...
  .hc .tcard-pill-dark i{color:#3D3D6E}
  ...
  .hc .strip-icon-red{background:linear-gradient(135deg,var(--red),#E53935)}
  .hc .strip-icon-dark{background:linear-gradient(135deg,#1A1A2E,#2D2D4E)}
  ...
  .hc .btn-white-dark{color:#1A1A2E}
  ...
  @media(max-width:480px){.hc .cta h2{font-size:22px}.hc .cta{padding:36px 16px}}
`
  ...
  return (
    <div className="hc">
      ...
      <div className="info-strip">
        <div className={`strip-icon ${modalidade === "federado" ? "strip-icon-dark" : "strip-icon-red"}`}>
          <i className={`ti ${mod.icon}`}></i>
        </div>
        <div className="strip-text">
          <b>
            {modalidade === "escolinha"
              ? "Vagas limitadas — formação individual"
              : "Seleção por avaliação técnica"}
          </b>
          <p>
            {modalidade === "escolinha"
              ? "As turmas da Escolinha têm capacidade reduzida para garantir atenção individual ao desenvolvimento de cada atleta."
              : "Os times federados participam de campeonatos oficiais. O ingresso pode exigir avaliação técnica. Entre em contato para saber mais."}
          </p>
        </div>
      </div>
        ...
        <div className="cta-inner">
          ...
          <p>
            {modalidade === "escolinha"
              ...
              : "Entre em contato e saiba como participar das avaliações para os times federados."}
          </p>
          <div className="cta-btns">
            <Link className={`btn-white ${modalidade === "federado" ? "btn-white-dark" : "btn-white-red"}`} href="/matricula">
